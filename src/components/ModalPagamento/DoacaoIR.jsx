...
const DoacaoIR = () => {
    ...
    return (
        <div style={{padding: '30px 10px 10px 40px'}}>
            <Typography variant="h4" component="h4" align="center" sx={{ fontFamily: 'Staatliches' }}>
                Doe parte do seu imposto de renda - FUNCRIANÇA
            </Typography>
            <Typography align='center' sx={{ fontFamily: 'BarlowRegular', fontWeight: 'bold', fontSize: { xs: '14px', md: '16px' } }}>
            ...
            <Typography sx={{ fontFamily: 'BarlowRegular', fontSize: { xs: '14px', md: '16px' } }}>
            ...
            <Typography sx={{ fontFamily: 'BarlowRegular', fontSize: { xs: '14px', md: '16px' }, fontWeight: 'bold', margin: '20px 0' }}>
            ...
            <Typography sx={{ fontFamily: 'BarlowRegular', fontSize: { xs: '14px', md: '16px' }, margin: '20px 0' }}>
            ...
            <Typography sx={{ fontFamily: 'BarlowRegular', fontSize: { xs: '14px', md: '16px' }, margin: '20px 0', fontWeight: 'bold' }}>
                Acesse o nosso projeto e faça a sua doação
            </Typography>
            <Link to="https://doacoes.prefeitura.poa.br/projeto/1859" target='blank'>
                <Typography className='texto_vermelho' sx={{ fontFamily: 'BarlowRegular', fontSize: { xs: '14px', md: '16px' }, margin: '20px 0', fontWeight: 'bold' }}>
